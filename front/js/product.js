...
const itemImg = document.querySelector(".item__img"); /* querySelector va chercher le selecteur css*/
const titleProduit = document.getElementById("title"); /* getElementByID va chercher le ID dans le html*/
const priceProduit = document.getElementById("price"); /*html*/
 ...
 */
function recuperationInformationsProduits() { /* debut fonction */
...
recuperationInformationsProduits(); /* excecute fonction */
 ...
 * qui lui convient.
 */
function traitementData(produitSelectionne) { /*debut focntion*/
...
function ajoutDuProduitDansPanier(produitSelectionne) {
    ...
    ajoutProduitDansPanier.addEventListener("click", function () { /* recupere ajout Produit panier et ajout un evenement click et execute la function */
